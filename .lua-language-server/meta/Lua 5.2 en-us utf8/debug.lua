...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-debug.getfenv"])
---
---@param o any
---@return table
---@nodiscard
...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-debug.setfenv"])
---
---@version 5.1
---@generic T
---@param object T

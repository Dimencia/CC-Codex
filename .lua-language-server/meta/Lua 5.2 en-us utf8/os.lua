...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-os.execute"])
---
...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-os.exit"])
---
...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-os.getenv"])
---
...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-os.remove"])
---
...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-os.rename"])
---
...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-os.setlocale"])
---
...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-os.tmpname"])
---
---@return string
---@nodiscard

...
---
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-bit32"])
---
---@class bit32lib
bit32 = {}
...
---
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-bit32.arshift"])
---
---@param x    integer
---@param disp integer
---@return integer
...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-bit32.band"])
---
---@return integer
---@nodiscard
...
---
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-bit32.bnot"])
---
---@param x integer
---@return integer
---@nodiscard
...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-bit32.bor"])
---
---@return integer
---@nodiscard
...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-bit32.btest"])
---
---@return boolean
---@nodiscard
...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-bit32.bxor"])
---
---@return integer
---@nodiscard
...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-bit32.extract"])
---
---@param n      integer
---@param field  integer
---@param width? integer
...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-bit32.replace"])
---
---@param n integer
---@param v integer
---@param field  integer
...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-bit32.lrotate"])
---
---@param x     integer
---@param distp integer
---@return integer
...
---
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-bit32.lshift"])
---
---@param x     integer
---@param distp integer
---@return integer
...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-bit32.rrotate"])
---
---@param x     integer
---@param distp integer
---@return integer
...
---
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-bit32.rshift"])
---
---@param x     integer
---@param distp integer
---@return integer

...
---
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-math.random"])
---
---@overload fun():number
...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-math.randomseed"])
---
---@param x integer

...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-arg"])
---
---@type string[]
arg = {}
...
---* `"setpause"`: sets arg as the new value for the pause of the collector (see [§2.5](command:extension.lua.doc?["en-us/52/manual.html/2.5"])). Returns the previous value for pause.
---* `"setstepmul"`: sets arg as the new value for the step multiplier of the collector (see [§2.5](command:extension.lua.doc?["en-us/52/manual.html/2.5"])). Returns the previous value for step.
---* `"isrunning"`: returns a boolean that tells whether the collector is running (i.e., not stopped).
---* `"generational"`: changes the collector to generational mode. This is an experimental feature (see [§2.5](command:extension.lua.doc?["en-us/52/manual.html/2.5"])).
---* `"incremental"`: changes the collector to incremental mode. This is the default mode.
---
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-collectgarbage52"])
---
...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-dofile"])
---
...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-getfenv"])
---
...
---
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-load"])
---
...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-loadfile"])
---
---@param filename? string
---@param mode?     loadmode
---@param env?      table
...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-loadstring"])
---
---@param text       string
---@param chunkname? string
---@return function?
...
---Creates a module.
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-module"])
---
---@param name string
---@param ...  any
...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-setfenv"])
---
...
---
---[View documents](command:extension.lua.doc?["en-us/52/manual.html/pdf-warn"])
---

...
- `codex/data/clients/<client-id>/request.json` and `result.json` - transient,
  client-scoped mailbox files. Separate terminal or pocket clients do not share
  request or result files.

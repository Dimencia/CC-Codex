...
local RenderModes = require("lib.image.render_modes")
...
function Spec.register(runner)
  runner.test("library loads do not touch CC globals", function()
    ...
    package.loaded["lib.image.palette"] = nil
    package.loaded["lib.image.loader"] = nil
    package.loaded["lib.image.monitor_renderer"] = nil
    local ok, message = pcall(function()
      require("lib.image.palette")
      require("lib.image.loader")
      require("lib.image.monitor_renderer")
    end)
